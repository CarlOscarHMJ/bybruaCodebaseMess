...
%                           printTimes=true)
rng(420)
plotFlags = ["flag_PSD_Any4Points","flag_C5Rwiv_AllSensors"];
flagNames = ["C1 PSD ($\geq$ 4 Peaks Any Dir.)","C5 PSD"];
...
if runOvernightOptimization
    ...
    [overnightResult, allStats] = runOvernightCableRwivOptimization(allStats, cableConfig, struct( ...
        ...
        'parallelizeSetups', true, ...
        'numSetupWorkers', 20, ...
        'runPrallel', false, ...
        'numWorkers', [], ...
        'display', "off", ...
        'verbose', true, ...
        'showProgressPlot', false, ...
        'progressUpdateEvery', 10, ...
        'checkpointEnabled', true, ...
        'checkpointEverySetups', 5, ...
        'checkpointEveryMinutes', 10, ...
        'checkpointFile', fullfile('figures', 'BridgeDataProcessed', 'OvernightOptimizationCheckpoint.mat'), ...
        'printProgressEverySetups', 1, ...
        'printProgressEveryMinutes', 2, ...
    ...
    outputDir = fullfile('figures', 'BridgeDataProcessed');
    if ~exist(outputDir, 'dir')
        mkdir(outputDir);
    end
    save(fullfile(outputDir, 'OvernightOptimizationResults.mat'), ...
        'overnightResult', 'cableConfig', 'limits', '-v7.3');
    save(fullfile(outputDir, 'OvernightOptimizationStats.mat'), ...
        'allStats', '-v7.3');
end
